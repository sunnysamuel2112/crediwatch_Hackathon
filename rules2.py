...
# Write alerts to CSV file
output_file = 'alerts.csv'
fieldnames = ['customer_name', 'customer_number', 'reporting_date', 'date_of_alert', 'category', 'rule_desc', 'rule_code']
...
print(f"Alerts have been written to {output_file}.")
